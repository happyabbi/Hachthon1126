...
*/	
	...
	//公車時刻表
	//"sb3"=>"http://opendata.hccg.gov.tw/dataset/432257df-491f-4875-8b56-dd814aee5d7b/resource/d2114863-5929-4846-b974-e51bda62241d/download/20161123141640887.json",//世博3號預估到站時刻表
	//"s51"=>"http://opendata.hccg.gov.tw/dataset/432257df-491f-4875-8b56-dd814aee5d7b/resource/3a9d8685-c583-4d9d-84f9-c5844771a221/download/20150305140446074.json",//世博3號預估到站時刻表
...
function toDB($key,$jsondata,$link){//寫入db  
	switch($key){
		case "sb3":
			LoadData("od_bstime",$jsondata,$link);
		break;
		case "sb3":
			LoadData("od_bstime",$jsondata,$link,0);
		break;
